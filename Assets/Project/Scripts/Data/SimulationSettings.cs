...
namespace RFSimulation.Data
{
    ...
    public class SimulationSettings : ScriptableObject
    {
        ...
        public void ResetToDefaults()
        {
            ...
            // Technology (5G defaults)
            defaultTransmitterPower = 43f;
            defaultAntennaGain = 18f;
            defaultFrequency = 3500f;
            defaultReceiverSensitivity = -105f;

            // Visualization
            showConnectionsByDefault = true;
            showCoverageByDefault = false;
            defaultLineWidth = 0.1f;
            ...
            allowLoadBalancing = true;

            // Buildings
            enableBuildingPenetration = false;
            buildingLayers = 1;
            maxBuildingPenetration = 2;

            Debug.Log("🔄 Settings reset to recommended defaults");
        ...
        /// <summary>
        /// Get settings optimized for performance
        /// </summary>
        [ContextMenu("Optimize for Performance")]
        public void OptimizeForPerformance()
        {
            updateFrequency = 0.5f; // Slower updates
            enableDebugLogs = false;
            animateConnections = false;
            enableLOD = true;
            lodDistance = 100f; // More aggressive LOD
            maxConnectionLines = 50; // Fewer lines
            enableConnectionCaching = true;
        ...
        /// <summary>
        /// Get settings optimized for visual quality
        /// </summary>
        [ContextMenu("Optimize for Quality")]
        public void OptimizeForQuality()
        {
            updateFrequency = 2f; // Faster updates
            showConnectionsByDefault = true;
            showCoverageByDefault = false;
            animateConnections = true;
            animationSpeed = 2f;
